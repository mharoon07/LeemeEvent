...
import { Sparkles, Eye, EyeOff, Compass, ArrowLeft, Calendar, Briefcase, Heart, Store } from 'lucide-react';
            ...
            <div className="max-w-md mx-auto w-full">
              ...
              <div className="text-center lg:text-left mb-6">
                ...
                <p className="text-xs text-charcoal/70 mt-1">
                  {mode === 'signup'
                    ? 'What brings you to LEEMEVENT? Choose your account role below.'
                    : 'Sign in to access your saved suppliers, events, or booking proposals.'}
                </p>
              </div>

              {/* Mode Switcher Tabs */}
              <div className="flex bg-sand-200/60 p-1.5 rounded-2xl mb-6">
                <button
                  type="button"
                  onClick={() => setMode('signup')}
                  className={`flex-1 py-2.5 text-xs font-classico tracking-wider uppercase font-semibold rounded-xl transition-all ${
                    mode === 'signup'
