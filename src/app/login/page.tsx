...
import { Sparkles, Eye, EyeOff, Compass, ArrowLeft, Heart, Store, Check, UserPlus, LogIn } from 'lucide-react';
          ...
          <div className="max-w-md mx-auto w-full py-8 sm:py-12">
            ...
            <div className="text-center lg:text-left mb-6">
              ...
              <div>
                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-taupe/15 border border-taupe/25 text-taupe text-xs font-semibold mb-3">
                  ...
                  <span>{mode === 'signin' ? t.auth.signInTab : t.auth.createAccountTab}</span>
                </div>
              </div>
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-charcoal mt-2 tracking-tight">
                {mode === 'signup' ? t.auth.startYourEvent : t.auth.welcomeBack}
              </h1>
              <p className="text-xs text-charcoal/70 mt-1">
                {mode === 'signup' ? t.auth.signUpSubtext : t.auth.signInSubtext}
              </p>
            </div>
            ...
            <div className="flex bg-stone/70 p-1.5 rounded-2xl mb-6 border border-taupe/25 shadow-inner relative">
              <button
                ...
                className={`relative flex-1 py-3 text-xs font-semibold rounded-xl transition-all duration-200 flex items-center justify-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-taupe ${
                  mode === 'signup'
              ...
              >
                ...
                <span>{t.auth.createAccountTab}</span>
              </button>
              <button
                type="button"
            ...
            <div className="relative my-6 text-center">
              ...
              <span className="relative bg-sand-50 px-3 text-xs text-charcoal/50">
                {mode === 'signin' ? t.auth.orContinueEmail : t.auth.orSignUpEmail}
              </span>
            </div>
            ...
            <div className="text-center pt-6 border-t border-taupe/15 mt-6 space-y-2">
              <p className="text-[11px] text-charcoal/60 leading-relaxed">
                {t.auth.termsNoticePart1}{' '}
                <a href="#" className="text-taupe underline font-semibold">{t.auth.termsLink}</a> {t.auth.termsNoticePart2}{' '}
                <a href="#" className="text-taupe underline font-semibold">{t.auth.privacyLink}</a>.
              </p>
